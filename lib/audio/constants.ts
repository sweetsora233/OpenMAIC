...
export const TTS_PROVIDERS: Record<BuiltInTTSProviderId, TTSProviderConfig> = {
  ...
  'server-tts': {
    ...
    voices: [
      // MOSS 原生音色 - 中文
      { id: 'default', name: '默认（Junhao）', language: 'zh-CN', gender: 'male' },
      { id: 'Junhao', name: 'Junhao（中文男声）', language: 'zh-CN', gender: 'male' },
      { id: 'Xiaoyu', name: 'Xiaoyu（中文男声）', language: 'zh-CN', gender: 'male' },
      { id: 'Yuewen', name: 'Yuewen（中文女声B）', language: 'zh-CN', gender: 'female' },
      { id: 'Lingyu', name: 'Lingyu（中文女声C）', language: 'zh-CN', gender: 'female' },
      { id: 'ZhExtra1', name: 'ZhExtra1（中文额外）', language: 'zh-CN', gender: 'neutral' },
      { id: 'ZhExtra2', name: 'ZhExtra2（中文额外）', language: 'zh-CN', gender: 'neutral' },
      // MOSS 原生音色 - 英文
      { id: 'Ava', name: 'Ava（英文女声A）', language: 'en-US', gender: 'female' },
      { id: 'Bella', name: 'Bella（英文女声B）', language: 'en-US', gender: 'female' },
      { id: 'Adam', name: 'Adam（英文男声）', language: 'en-US', gender: 'male' },
      { id: 'EnExtra1', name: 'EnExtra1（英文额外）', language: 'en-US', gender: 'neutral' },
      { id: 'EnExtra2', name: 'EnExtra2（英文额外）', language: 'en-US', gender: 'neutral' },
      { id: 'EnExtra3', name: 'EnExtra3（英文额外）', language: 'en-US', gender: 'neutral' },
      // MOSS 原生音色 - 日文
      { id: 'Yui', name: 'Yui（日文女声）', language: 'ja', gender: 'female' },
      // OpenAI 标准 6 种音色（映射到 MOSS）
      { id: 'alloy', name: 'Alloy → Adam', language: 'en-US', gender: 'male' },
      { id: 'echo', name: 'Echo → Adam', language: 'en-US', gender: 'male' },
      { id: 'fable', name: 'Fable → Ava', language: 'en-US', gender: 'female' },
      { id: 'onyx', name: 'Onyx → Junhao', language: 'zh-CN', gender: 'male' },
      { id: 'nova', name: 'Nova → Bella', language: 'en-US', gender: 'female' },
      { id: 'shimmer', name: 'Shimmer → Ava', language: 'en-US', gender: 'female' },
      // MOSS 旧音色名兼容（音频缺失，自动映射）
      { id: 'zhiming', name: 'zhiming → Junhao', language: 'zh-CN', gender: 'male' },
      { id: 'weiguo', name: 'weiguo → Junhao', language: 'zh-CN', gender: 'male' },
      { id: 'trump', name: 'trump → Adam', language: 'en-US', gender: 'male' },
      { id: 'nathan', name: 'nathan → Adam', language: 'en-US', gender: 'male' },
      { id: 'sakura', name: 'sakura → Yui', language: 'ja', gender: 'female' },
      { id: 'aoi', name: 'aoi → Yui', language: 'ja', gender: 'female' },
      { id: 'hina', name: 'hina → Yui', language: 'ja', gender: 'female' },
      { id: 'mei', name: 'mei → Yui', language: 'ja', gender: 'female' },
    ],
